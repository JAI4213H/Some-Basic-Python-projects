...
def submitstuff():
    ...
    print("Both the features are:  ", storing_string_for_column1.get(),storing_string_for_column2.get())
...
def makegraph(frame):
    ...
    type_graph = getattr(ax , storing_string_for_column3.get())
...
column1 = ttk.Combobox(root,textvariable=storing_string_for_column1)
column2 = ttk.Combobox(root,textvariable=storing_string_for_column2)
column3 = ttk.Combobox(root,textvariable=storing_string_for_column3)
